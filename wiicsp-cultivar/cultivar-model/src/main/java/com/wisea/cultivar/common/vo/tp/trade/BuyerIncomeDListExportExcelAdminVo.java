 ...
 *
 */
public class BuyerIncomeDListExportExcelAdminVo {
	...
	@ExcelField(title = "会员账号", sort = 3, width = 20)
	...
	@ExcelField(title = "订单运费", sort = 6, width = 20)
	...
	@ExcelField(title = "运营服务费", sort = 8, width = 20)
    private Double operSerCharge;

	@ApiModelProperty("技术服务费")
	@ExcelField(title = "技术服务费", sort = 9, width = 20)
