...
public class OrgInfoMageExportDepartmentVo implements Serializable{

    //行政区划代码、部门名称、部门地址、部门介绍、机构负责人、负责人职务、部门联系人、部门联系方式、经纬度
    ...
    * 部门名称
    */
    @ExcelField(title = "部门名称", width = 40)
    private String orgName;

    /**
    * 部门地址
    */
    @ExcelField(title = "部门地址", width = 20)
    private String orgAddress;

    /**
    * 部门介绍
    */
    @ExcelField(title = "部门介绍", width = 20)
    private String orgIntroduce;

    /**
    * 部门负责人
    */
    @ExcelField(title = "部门负责人", width = 20)
    ...
    * 联系人
    */
    @ExcelField(title = "部门联系人", width = 20)
    private String conter;

    /**
    * 联系方式
    */
    @ExcelField(title = "部门联系方式**请右击此列设置单元格格式为文本格式", width = 30, cellDataFormateAuto = false, fieldType = String.class)
