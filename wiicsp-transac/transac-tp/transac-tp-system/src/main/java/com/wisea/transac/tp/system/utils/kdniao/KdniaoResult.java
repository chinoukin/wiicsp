...
public class KdniaoResult {
    ...
    private List<KdniaoResult.Traces> Traces;
    ...
    public List<KdniaoResult.Traces> getTraces() {
        return Traces;
    }

    public void setTraces(List<KdniaoResult.Traces> Traces) {
        this.Traces = Traces;
    }
