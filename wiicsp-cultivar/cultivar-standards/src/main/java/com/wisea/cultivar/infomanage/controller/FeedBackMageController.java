...
import com.wisea.cultivar.infomanage.service.FeedBackMageService;
...
@PreAuthorize("hasAuthority('im:feb')")
@Api(tags = "意见反馈管理")
public class FeedBackMageController {
    ...
    @ApiOperation(nickname = "导出意见反馈管理信息", value = "查询详细信息", notes = "查询详细信息", httpMethod = "POST")
