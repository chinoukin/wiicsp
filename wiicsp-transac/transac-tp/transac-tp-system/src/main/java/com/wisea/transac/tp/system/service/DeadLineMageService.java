...
import com.wisea.transac.common.po.system.DeadLineInsertPo;
...
public class DeadLineMageService extends BaseService {
    ...
    private DeadLineMage getDeadLineMage(String deadLineType, DeadLineInsertPo po){
        ...
        }else if(deadLineType.equals(DictConstants.DEAD_LINE_TYPE_2)){
            deadLine.setLimitDays(po.getDeliveryDeadline());
        }else if(deadLineType.equals(DictConstants.DEAD_LINE_TYPE_3)){
            deadLine.setLimitDays(po.getInvoDeadline());
        }else if(deadLineType.equals(DictConstants.DEAD_LINE_TYPE_4)){
            deadLine.setLimitDays(po.getAssessDeadline());
        }else if(deadLineType.equals(DictConstants.DEAD_LINE_TYPE_5)){
            deadLine.setLimitDays(po.getReconcDeadline());
        }else if(deadLineType.equals(DictConstants.DEAD_LINE_TYPE_6)){
            deadLine.setLimitDays(po.getBillingDeadline());
        }else if(deadLineType.equals(DictConstants.DEAD_LINE_TYPE_7)){
            deadLine.setLimitDays(po.getTicketCheckDeadline());
        }
        deadLine.preInsert();
        return deadLine;
    }
