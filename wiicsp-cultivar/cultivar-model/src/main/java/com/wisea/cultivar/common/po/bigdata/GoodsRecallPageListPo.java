...
import com.wisea.cultivar.common.vo.bigdata.GoodsRecallPageListVo;
import io.swagger.annotations.ApiModel;
import io.swagger.annotations.ApiModelProperty;

import java.time.OffsetDateTime;

@ApiModel("分页查询GoodsRecallPo")
public class GoodsRecallPageListPo extends PagePo<GoodsRecallPageListVo> {
