...
/**
 * StandardRuleMagePagePo
 * 2020/07/24 11:21:45
 */
public class StandardRuleMagePagePo extends PagePo<StandardRuleMageListVo> {
    ...
    @ApiModelProperty(value = "标准编号或中英文名称或发布部门")
    private String numberAndnameAnddepartment;
    @JsonSerialize(using = OffsetDateTimeSerializer.class)
    @JsonDeserialize(using = OffsetDateTimeDeserializer.class)
    @ApiModelProperty(value = "实施日期开始")
    private OffsetDateTime startImpleDate;
    @JsonSerialize(using = OffsetDateTimeSerializer.class)
    @JsonDeserialize(using = OffsetDateTimeDeserializer.class)
    @ApiModelProperty(value = "实施日期结束")
    private OffsetDateTime endImpleDate;

    public String getNumberAndnameAnddepartment() {
        return numberAndnameAnddepartment;
    }

    public void setNumberAndnameAnddepartment(String numberAndnameAnddepartment) {
        this.numberAndnameAnddepartment = numberAndnameAnddepartment;
    }

    public OffsetDateTime getStartImpleDate() {
        return startImpleDate;
    }

    public void setStartImpleDate(OffsetDateTime startImpleDate) {
        this.startImpleDate = startImpleDate;
    }

    public OffsetDateTime getEndImpleDate() {
        return endImpleDate;
    }

    public void setEndImpleDate(OffsetDateTime endImpleDate) {
        this.endImpleDate = endImpleDate;
    }
