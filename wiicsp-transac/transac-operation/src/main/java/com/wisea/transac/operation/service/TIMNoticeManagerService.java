...
import com.wisea.transac.operation.properties.TIMNoticeProperties;
...
import com.wisea.transac.operation.entity.TIMNoticeUser;
...
public class TIMNoticeManagerService {
    ...
    public ResultPoJo<Object> sendTIMNotice(TIMNoticeSendPo po) {
        ...
        // 创建时间
        String createDate = ConverterUtil.toString(ConverterUtil.offsetDateTimeToLong(now));
        // 经过测试createDate会被腾讯自动转换成错误的日期，无法使用
        // dataMap.put("createDate", createDate);
        dataMap.put("createStamp", createDate);
