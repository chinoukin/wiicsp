...
import com.wisea.transac.seller.service.ApPayMageService;
 ...
 * @version 1.0
 * @className ApPayMageController
 * @date 2020/04/27 17:01:29
 * @Description
 */
@Api(tags = "我的授信")
@RestController
@RequestMapping("/w/ApPayMage")
public class ApPayMageController {
    ...
    public ResultPoJo<Page<ApPayMagePageListVo>> findPageList(@RequestBody ApPayMagePageListPo po) {
