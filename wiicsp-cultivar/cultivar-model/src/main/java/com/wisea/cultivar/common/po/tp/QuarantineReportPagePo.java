...
/**
 * QuarantineReportPagePo
 * 2019/01/14 13:35:42
 */
public class QuarantineReportPagePo extends PagePo<QuarantineReportListVo> {
    ...
    public String getCommPubInfoId() {
        return commPubInfoId;
    }

    public void setCommPubInfoId(String commPubInfoId) {
