...
public class CommUtils {
    ...
    public static String getCommMageNames(Long commMageId) {
        //查询品类列表
        List<ZhfwCommMageTreeVo> commMages = commMageMapper.findList(new CommMageTreePo());
        Map<Long, ZhfwCommMageTreeVo> commMageMap = commMages.stream().collect(Collectors.toMap(ZhfwCommMageTreeVo::getId, Function.identity()));
    ...
    public static List<String> diGuiCommMageName(Map<Long, ZhfwCommMageTreeVo> commMageMap, Long commMageId, List<String> mageNames, List<String> mageids) {
        ZhfwCommMageTreeVo commMage = commMageMap.get(commMageId);
