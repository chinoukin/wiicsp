...
public class LtaRefundCommAppl extends DataLongEntity<LtaRefundCommAppl> {
    /**
     * 长协订单商品id
     */
    private Long ltaOrdCommId;
    ...
    public Long getLtaOrdCommId() {
        return ltaOrdCommId;
    }

    public void setLtaOrdCommId(Long ltaOrdCommId) {
        this.ltaOrdCommId = ltaOrdCommId;
    }
