...
/**
 * QuarantineReportGetVo
 * 2019/01/14 13:35:42
 */
public class QuarantineReportGetVo {
    /**
     * id
     */
    ...
    @ApiModelProperty(value = "检疫合格证图片信息")
    private List<QuarantinePictureGetVo> quarantinePictureGetVo;
    ...
    public List<QuarantinePictureGetVo> getQuarantinePictureGetVo() {
        return quarantinePictureGetVo;
    }

    public void setQuarantinePictureGetVo(List<QuarantinePictureGetVo> quarantinePictureGetVo) {
        this.quarantinePictureGetVo = quarantinePictureGetVo;
    }
