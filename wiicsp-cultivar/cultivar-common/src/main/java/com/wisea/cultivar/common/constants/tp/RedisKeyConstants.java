...
public class RedisKeyConstants {
	...
	public static final String LTA_REFUND_CODE_FIX = "LTA_REFUND_CODE_FIX"; //长协退货、退货退款编号key前缀（规则为前缀加12位随机数，没有过期时间）
	public static final String ORDER_CODE_FIX = "ORDER_CODE_FIX"; //订单编号key前缀（规则为前缀加12位随机数，没有过期时间）
	public static final String LTA_ORDER_CODE_FIX = "LTA_ORDER_CODE_FIX"; //长协订单编号key前缀（规则为前缀加12位随机数，没有过期时间）
    ...
    // 长协商品单号key前缀
    public static final String LTA_CONT_NUM_INFO_FIX = "LTA_CONT_NUM_INFO_FIX_";//长协合同编号前缀
    public static final String LTA_COMM_PUB_INFO_FIX = "LTA_COMM_PUB_INFO_FIX";
    public static final String ORDER_INVO_APPL_FIX = "ORDER_INVO_APPL_FIX";//订单发票申请开票服务单号key前缀
    public static final String LTA_ORDER_INVO_APPL_FIX = "LTA_ORDER_INVO_APPL_FIX";//长协订单发票申请开票服务单号key前缀
    ...
    public static final String LTA_CONT_NUM_CODE = "LTA_CONT_NUM_CODE";//长协合同编号
	...
	/************************分布式锁***********************/
	public static final String REFUND_CODE_LOCK = "REFUND_CODE_LOCK"; //长协退货、退货退款编号锁key
	public static final String LTA_REFUND_CODE_LOCK = "LTA_REFUND_CODE_LOCK"; //退货、退货退款编号锁key
	public static final String ORDER_CODE_LOCK = "ORDER_CODE_LOCK"; //订单编号锁key
	public static final String LTA_ORDER_CODE_LOCK = "LTA_ORDER_CODE_LOCK"; //长协订单编号锁key
	public static final String SETTLE_BILL_CODE_LOCK = "SETTLE_BILL_CODE_LOCK"; //结算单编号锁key
    // 商品单号key前缀
    public static final String COMM_PUB_INFO_LOCK = "COMM_PUB_INFO_LOCK";
    // 长协商品单号key前缀
    public static final String LTA_COMM_PUB_INFO_LOCK = "LTA_COMM_PUB_INFO_LOCK";
    public static final String ORDER_INVO_APPL_LOCK = "ORDER_INVO_APPL_LOCK";//订单发票申请开票服务单号锁key
    public static final String LTA_ORDER_INVO_APPL_LOCK = "LTA_ORDER_INVO_APPL_LOCK";//长协订单发票申请开票服务单号锁key
    public static final String SETTLE_ORDER_INVO_APPL_LOCK = "SETTLE_ORDER_INVO_APPL_LOCK";//订单发票申请开票服务单号锁key
    public static final String ZT_NUM_LOCK = "ZT_NUM_LOCK";//自提码锁key
    public static final String LTA_CONT_NUM_LOCK = "LTA_CONT_NUM_LOCK";//长协合同编号锁Key
