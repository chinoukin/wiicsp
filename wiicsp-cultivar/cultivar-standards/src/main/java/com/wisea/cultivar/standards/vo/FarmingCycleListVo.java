 ...
 * 2020/07/24 11:21:45
 */
public class FarmingCycleListVo {
    /**
     * id
     */
    ...
    private List<FarmingStageListVo> farmingStageListVo;


    public List<FarmingStageListVo> getFarmingStageListVo() {
        return farmingStageListVo;
    }

    public void setFarmingStageListVo(List<FarmingStageListVo> farmingStageListVo) {
        this.farmingStageListVo = farmingStageListVo;
    }
