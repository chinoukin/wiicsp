 ...
 * 2019/12/02 11:02:14
 */
public class CarJcInfoPagePo extends PagePo<CarJcInfoListVo> {
     ...
     * 车牌号
     */
    @ApiModelProperty(value = "车牌号,条件查询")
    private String carNum;

    /**
     * 车辆类型
     */
    @ApiModelProperty(value = "车辆类型,条件查询")
     ...
     * 车辆状态
     */
    @ApiModelProperty(value = "车辆状态,条件查询")
