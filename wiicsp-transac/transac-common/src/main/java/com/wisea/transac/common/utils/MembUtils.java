...
public class MembUtils {
     ...
     * @version 1.0
     */
    public static MembLoginCityOrLocInfo sellerAppLoginCheck(LoginNameOrMobilePo po){
    	return membInfoMapper.sellerAppLoginCheck(po);
    }
    /**
     * 通过用户名称查询市场或者运营平台人员信息(*登录用勿改)
     *
     * @author wangh(wisea)
     *
     * @date 2020年5月11日
	 ...
	 * @version 1.0
	 */
	public static void RemoveMobileLoginRefresh(String id){
		// 根据ID查询refresh_toke
		jedisdao.delStr(mobileLoginRefreshKey(id));
	}
	/**
	...
	public static String randomPetName(){
		return "用户" + MembUtils.getFixLenthString(10);
	}
}
