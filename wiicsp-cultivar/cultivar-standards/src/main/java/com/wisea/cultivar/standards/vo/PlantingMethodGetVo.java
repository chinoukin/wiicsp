...
public class PlantingMethodGetVo {
    ...
    private List<FarmingCycleListVo> farmingCycleListVo;


    public List<FarmingCycleListVo> getFarmingCycleListVo() {
        return farmingCycleListVo;
    }

    public void setFarmingCycleListVo(List<FarmingCycleListVo> farmingCycleListVo) {
        this.farmingCycleListVo = farmingCycleListVo;
    }
