 ...
 * 2020/07/24 11:21:45
 */
public class EntpInfoMageListPo {
     ...
     * 是否填写地址
     */
    @ApiModelProperty(value = "是否填写地址--1：有；2：没有")
    ...
    public EntpInfoMageListPo() {
    }

    public EntpInfoMageListPo(String entpMainBusinessType) {
        this.entpMainBusinessType = entpMainBusinessType;
    }
