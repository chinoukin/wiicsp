 ...
 * 机构
 */
public class OrgInfoMageImportPo implements Serializable{
    ...
    * 机构地址
    */
    @ExcelField(title = "机构地址")
    private String orgAddress;

    /**
    * 机构介绍
    */
    @ExcelField(title = "机构介绍")
    private String orgIntroduce;

    /**
    * 机构负责人
    */
    @ExcelField(title = "机构负责人")
    ...
    * 联系人
    */
    @ExcelField(title = "机构联系人")
    private String conter;

    /**
    * 联系方式
    */
    @ExcelField(title = "机构联系方式", cellDataFormateAuto = false,fieldType = String.class)
    ...
    */
    ...
    public boolean equals(Object o) {
        ...
        OrgInfoMageImportPo that = (OrgInfoMageImportPo) o;
