...
/**
 * SubEntpMbInfoMagePagePo
 * 2019/12/02 11:02:15
 */
public class SubEntpMbInfoMagePagePo extends PagePo<SubEntpMbInfoMageListVo> {
     ...
     * 年目标数据
     */
    @ApiModelProperty(value = "年目标数据")
    private Double nMbsj;

    /**
     * 一月目标数据
     */
    @ApiModelProperty(value = "一月目标数据")
    private Double oneMbsj;

    /**
     * 二月目标数据
     */
    @ApiModelProperty(value = "二月目标数据")
    private Double twoMbsj;

    /**
     * 三月目标数据
     */
    @ApiModelProperty(value = "三月目标数据")
    private Double threeMbsj;

    /**
     * 四月目标数据
     */
    @ApiModelProperty(value = "四月目标数据")
    private Double fourMbsj;

    /**
     * 五月目标数据
     */
    @ApiModelProperty(value = "五月目标数据")
    private Double fiveMbsj;

    /**
     * 六月目标数据
     */
    @ApiModelProperty(value = "六月目标数据")
    private Double sixMbsj;

    /**
     * 七月目标数据
     */
    @ApiModelProperty(value = "七月目标数据")
    private Double sevenMbsj;

    /**
     * 八月目标数据
     */
    @ApiModelProperty(value = "八月目标数据")
    private Double eightMbsj;

    /**
     * 九月目标数据
     */
    @ApiModelProperty(value = "九月目标数据")
    private Double nineMbsj;

    /**
     * 十月目标数据
     */
    @ApiModelProperty(value = "十月目标数据")
    private Double tenMbsj;

    /**
     * 十一月目标数据
     */
    @ApiModelProperty(value = "十一月目标数据")
    private Double elevenMbsj;

    /**
     * 十二月目标数据
     */
    @ApiModelProperty(value = "十二月目标数据")
