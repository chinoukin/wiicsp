...
import com.wisea.transac.common.po.customer.OperationCustomerConfigGetVo;
import com.wisea.transac.common.po.customer.OperationCustomerSavePo;
import com.wisea.transac.operation.service.OperationCustomerService;
...
public class OperationCustomerController {
    ...
    @DataCheck
    public ResultPoJo<Object> update(@RequestBody OperationCustomerSavePo updatePo) {
