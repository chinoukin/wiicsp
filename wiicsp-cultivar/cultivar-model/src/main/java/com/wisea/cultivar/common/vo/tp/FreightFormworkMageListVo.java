...
/**
 * FreightFormworkMageListVo
 * 2018/09/18 14:36:47
 */
public class FreightFormworkMageListVo {
    /**
     * id
     */
    ...
    private List<FreightSetListVo> freightSetListVos;
    ...
    public List<FreightSetListVo> getFreightSetListVos() {
        return freightSetListVos;
    }

    public void setFreightSetListVos(List<FreightSetListVo> freightSetListVos) {
        this.freightSetListVos = freightSetListVos;
    }
