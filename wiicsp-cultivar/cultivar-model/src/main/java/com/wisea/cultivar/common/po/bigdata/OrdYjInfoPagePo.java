 ...
 * 2019/12/02 11:02:15
 */
public class OrdYjInfoPagePo extends PagePo<OrdYjInfoListVo> {
     ...
     * 产地地址
     */
    @ApiModelProperty(value = "产地地址,条件查询")
     ...
     * 预警类型
     */
    @ApiModelProperty(value = "预警类型,条件查询")
    private String yjType;

    /**
     * 物流司机电话
     */
    @ApiModelProperty(value = "物流司机电话,条件查询")
