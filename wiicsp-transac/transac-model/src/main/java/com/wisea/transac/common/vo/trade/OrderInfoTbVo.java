...
public class OrderInfoTbVo {
    ...
    private List<OrdCommRelaTbVo> ordCommRelaTbs;
    ...
    public List<OrdCommRelaTbVo> getOrdCommRelaTbs() {
        return ordCommRelaTbs;
    }

    public void setOrdCommRelaTbs(List<OrdCommRelaTbVo> ordCommRelaTbs) {
