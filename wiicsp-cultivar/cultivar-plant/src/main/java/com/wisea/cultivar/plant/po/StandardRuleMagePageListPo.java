...
@ApiModel("分页查询StandardRuleMagePo")
public class StandardRuleMagePageListPo extends PagePo<StandardRuleMagePageListVo> {

    @ApiModelProperty(value="标准类型id")
    private Long standardTypeMageId;

    @ApiModelProperty(value="所属环节")
    private String linkMageName;
    ...
    public String getLinkMageName() {
        return linkMageName;
    }

    public void setLinkMageName(String linkMageName) {
        this.linkMageName = linkMageName;
    }
