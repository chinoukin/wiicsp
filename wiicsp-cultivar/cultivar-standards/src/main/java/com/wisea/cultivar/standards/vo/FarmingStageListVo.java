 ...
 * 2020/07/24 11:21:45
 */
public class FarmingStageListVo {
    /**
     * id
     */
     ...
     */
    @JsonSerialize(using = IdSerializer.class)
    @ApiModelProperty(value = "农事类型字典名称")
    ...
    private List<StagePictureListVo> stagePictureListVo;

    public List<StagePictureListVo> getStagePictureListVo() {
        return stagePictureListVo;
    }

    public void setStagePictureListVo(List<StagePictureListVo> stagePictureListVo) {
        this.stagePictureListVo = stagePictureListVo;
    }
