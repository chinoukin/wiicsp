...
/**
 * StandardRuleMageListVo
 * 2020/07/24 11:21:45
 */
public class StandardRuleMageListVo {
    /**
     * id
     */
    ...
    @ApiModelProperty(value = "标准类型id的名称")
    ...
    @ApiModelProperty(value = "国标条数")
    private String gbcount;
    @ApiModelProperty(value = "地标条数")
    private String dbcount;
    @ApiModelProperty(value = "行标条数")
    private String hbcount;
    @ApiModelProperty(value = "其他条数")
