...
import com.wisea.transac.common.utils.BatchUtil;
...
import com.wisea.transac.operation.dao.SendMessageMapper;
import com.wisea.transac.operation.dao.SendMessageReciverMapper;
...
public class SendMessageService extends BaseService {
    ...
    public ResultPoJo<Object> insert(SendMessagePo po) {
        ...
        // 新增子表
        BatchUtil.batchSQL(msgReciverLst, s -> sendMessageReciverMapper.batchInsert(s));
