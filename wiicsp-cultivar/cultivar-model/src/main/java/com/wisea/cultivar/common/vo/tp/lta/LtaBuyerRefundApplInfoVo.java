...
public class LtaBuyerRefundApplInfoVo {
    ...
    private LtaOrderInfoVo orderInfoVo;
	...
	public LtaOrderInfoVo getOrderInfoVo() {
		return orderInfoVo;
	}
	public void setOrderInfoVo(LtaOrderInfoVo orderInfoVo) {
