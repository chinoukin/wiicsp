...
/**
 * FarmWorkTypeDictListVo
 * 2020/07/24 11:21:45
 */
public class FarmWorkTypeDictListVo {
    /**
     * id
     */
    ...
    private List<FarmWorkTypeDictListVo> children = new ArrayList<FarmWorkTypeDictListVo>();

    public List<FarmWorkTypeDictListVo> getChildren() {
        return children;
    }

    public void setChildren(List<FarmWorkTypeDictListVo> children) {
