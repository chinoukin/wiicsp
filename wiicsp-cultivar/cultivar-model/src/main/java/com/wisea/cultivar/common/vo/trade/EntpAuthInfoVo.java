...
public class EntpAuthInfoVo implements Serializable{
    ...
    @ApiModelProperty(value="定点企业关联id")
    private Long seId;

    @ApiModelProperty(value="历年种苗目录id")
    private Long scmId;
    ...
    @ApiModelProperty(value="审核状态(auth_state_type 0:审核通过1:审核未通过 )")
    private String authStateType;

    @ApiModelProperty(value="审核状态值(auth_state_type_value 0:审核通过1:审核未通过 )")
