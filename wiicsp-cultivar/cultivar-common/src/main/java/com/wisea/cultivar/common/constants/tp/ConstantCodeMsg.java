...
public class ConstantCodeMsg extends ConstantError {
    ...
    /*** 该商品分类下存在状态为【已上架】、【未上架】的商品，不能删除 */
    public static final String MSG_365 = "该商品分类下存在状态为【已上架】、【未上架】的商品，不能删除";
    /*** 分类名称【{0}】已存在 */
     ...
     */
    public static final String MSG_360 = "信息状态都是已上架";
    /**
    ...
    /**
     * err message:351 Reselect validity.
     */
    public static final String MSG_351 = "重新选择有效期";
    /**
     * err code:351 Reselect validity.
     */
    public static final String ERR_351 = "351";

    /*** 该品种下存在状态为【已上架】、【未上架】的商品，不能删除 */
    public static final String ERR_350 = "350";
    /*** 该品种下存在状态为【已上架】、【未上架】的商品，不能删除 */
    public static final String MSG_350 = "该品种下存在状态为【已上架】、【未上架】的商品，不能删除";
    ...
    /*** 错误消息:410 追溯码不正确*/
    public static final String MSG_410 = "追溯码不正确";

    /*** 错误代码:411 订单存在待处理的退款申请，不能发货。*/
    public static final String ERR_411 = "411";
    /*** 错误消息:411 订单存在待处理的退款申请，不能发货。*/
    public static final String MSG_411 = "订单存在待处理的退款申请，不能发货。";
    ...
    /*** 错误代码:415 待发货的订单不允许修改【配送类型】*/
    public static final String ERR_415 = "415";
    /*** 错误消息:415 待发货的订单不允许修改【配送类型】*/
    public static final String MSG_415 = "待发货的订单不允许修改【配送类型】";
    ...
    /*** 错误代码:418 商户未开通账期支付功能*/
    public static final String ERR_418 = "418";
    /*** 错误消息:418 商户未开通账期支付功能*/
    public static final String MSG_418 = "商户未开通账期支付功能";
    ...
    /*** 错误代码:426 企业或个人未做实名认证，不能授予账期*/
    public static final String ERR_426 = "426";
    /*** 错误消息:426 企业或个人未做实名认证，不能授予账期*/
    public static final String MSG_426 = "企业或个人未做实名认证，不能授予账期";
    ...
    /*** 错误代码:517 用户没有进行绑定。*/
    public static final String ERR_517 = "516";
    /*** 错误消息:517 用户没有进行绑定*/
    ...
    /*** 错误消息:518 openid已经存在*/
    public static final String MSG_518 = "该用户已经绑定";
    ...
    /*** 错误消息:809 根节点不能删除。*/
    public static final String MSG_809 = "根节点不能删除。";
    /*** 错误代码:427 批次不存在*/
