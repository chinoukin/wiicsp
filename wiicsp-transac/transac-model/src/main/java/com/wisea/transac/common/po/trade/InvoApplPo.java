...
public class InvoApplPo {
    ...
    @ApiModelProperty(value = "账期、订单标识 0账期，1发票")
    private String settOrdFlag;
    ...
    public String getSettOrdFlag() {
        return settOrdFlag;
    }
    public void setSettOrdFlag(String settOrdFlag) {
        this.settOrdFlag = settOrdFlag;
    }
}
