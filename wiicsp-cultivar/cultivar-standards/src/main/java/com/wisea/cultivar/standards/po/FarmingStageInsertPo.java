...
/**
 * FarmingStageInsertPo
 * 2020/07/24 11:21:45
 */
public class FarmingStageInsertPo  extends DataLongEntity<FarmingCycleInsertPo> {
    /**
     * 农事周期id
     */
    ...
    private List<StagePictureInsertPo> stagePictureInsertPo;

    public List<StagePictureInsertPo> getStagePictureInsertPo() {
        return stagePictureInsertPo;
    }

    public void setStagePictureInsertPo(List<StagePictureInsertPo> stagePictureInsertPo) {
        this.stagePictureInsertPo = stagePictureInsertPo;
    }
