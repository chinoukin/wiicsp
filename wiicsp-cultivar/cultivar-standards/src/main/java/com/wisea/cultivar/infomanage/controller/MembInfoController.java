...
import com.wisea.cultivar.infomanage.service.MembInfoService;
...
public class MembInfoController {
	...
	@DataCheck
	public ResultPoJo<Page<MembInfoListForMsgVo>> membListForMsg(@RequestBody MembListForMsgPo po){
		// 返回参数
	...
	@ApiOperation(nickname = "设置用户名密码判断",value = "设置用户名密码判断",notes = "设置用户名密码判断")
