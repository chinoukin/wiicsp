...
/**
 * OilTeaVarietMageInsertPo
 * 2020/07/24 11:21:45
 */
public class OilTeaVarietMageInsertPo {
    /**
     * 品种名称
     */
    ...
    @ApiModelProperty(value = "亩种植数", allowableValues = "regex:^\\s*$|^[1-9]\\d*(\\.[0-9]+)?$|^0$")
     ...
     */
    @Check(test = { "regex" }, regex = "^\\s*$|^[1-9]\\d*(\\.[0-9]+)?$|^0$")
    @ApiModelProperty(value = "亩均产果", allowableValues = "regex:^\\s*$|^[1-9]\\d*(\\.[0-9]+)?$|^0$")
     ...
     */
    @Check(test = { "regex" }, regex = "^\\s*$|^[1-9]\\d*(\\.[0-9]+)?$|^0$")
    @ApiModelProperty(value = "亩均产籽", allowableValues = "regex:^\\s*$|^[1-9]\\d*(\\.[0-9]+)?$|^0$")
     ...
     */
    @Check(test = { "regex" }, regex = "^\\s*$|^[1-9]\\d*(\\.[0-9]+)?$|^0$")
    @ApiModelProperty(value = "亩均产油", allowableValues = "^\\s*$|^[1-9]\\d*(\\.[0-9]+)?$|^0$")
