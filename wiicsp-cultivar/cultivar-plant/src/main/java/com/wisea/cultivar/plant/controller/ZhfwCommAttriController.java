...
import com.wisea.cultivar.plant.service.ZhfwCommAttriService;
 ...
 * @version 1.0
 * @className ZhfwCommAttriController
 * @date 2020/08/06 18:28:39
 * @Description
 */
@RestController
@RequestMapping("/w/ZhfwCommAttri")
public class ZhfwCommAttriController {
    @Autowired
    private ZhfwCommAttriService service;
    ...
    public ResultPoJo<Page<ZhfwCommAttriPageListVo>> findPageList(@RequestBody ZhfwCommAttriPageListPo po) {
    ...
    public ResultPoJo saveOrUpdate(@RequestBody ZhfwCommAttriPo po) {
    ...
    public ResultPoJo<ZhfwCommAttriInfoVo> findInfo(@RequestBody LongIdPo po) {
