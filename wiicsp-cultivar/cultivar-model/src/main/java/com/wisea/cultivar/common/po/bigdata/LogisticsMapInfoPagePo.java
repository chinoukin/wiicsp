...
/**
 * LogisticsMapInfoPagePo
 * 2019/12/02 11:02:14
 */
public class LogisticsMapInfoPagePo extends PagePo<LogisticsMapInfoListVo> {
     ...
     * 订单编号
     */
    @ApiModelProperty(value = "订单编号,条件查询")
    ...
    @ApiModelProperty(value = "下单时间,条件查询")
    ...
    @JsonSerialize(using = OffsetDateTimeSerializer.class)
    @JsonDeserialize(using = OffsetDateTimeDeserializer.class)
    @ApiModelProperty(value = "发货时间,条件查询")
